  ...
  const fetchProperties = useCallback(
    async (refetch?: boolean) => {
      try {
        ...
        const properties = await getProperties(program, [], null, refetch);
        ...
        <Tabs defaultValue="properties" className="mb-6">
          ...
          <TabsContent value="properties">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-3xl font-bold">Explore Properties</h2>
          ...
          <TabsContent value="investments">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-3xl font-bold">Your Investments</h2>
              <div className="flex space-x-2">
                <Button variant="outline">Filters</Button>
                <Button variant="outline">Sort</Button>
              </div>
            ...
            {isLoadingInvestments ? (
              ...
              <p className="text-muted-foreground">You have no investments.</p>
            )}
          </TabsContent>
        </Tabs>
      </main>
